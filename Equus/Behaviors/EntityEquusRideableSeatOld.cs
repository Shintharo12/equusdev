...
{
    public class EntityEquusRideableSeatOld : EntitySeat
    {
        public override EnumMountAngleMode AngleMode => EnumMountAngleMode.FixateYaw;
        public override AnimationMetaData SuggestedAnimation => (mountedEntity as EntityBehaviorEquusRideableOld).curAnim;
        ...
        public EntityEquusRideableSeatOld(IMountable mountablesupplier, string seatId, SeatConfig config) : base(mountablesupplier, seatId, config)
        {
        }
