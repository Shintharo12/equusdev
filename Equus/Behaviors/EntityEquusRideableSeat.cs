...
namespace Equus.Behaviors
{
    ...
    public class EntityEquusRideableSeat : EntitySeat
    {
        public override EnumMountAngleMode AngleMode => EnumMountAngleMode.FixateYaw;
        public override AnimationMetaData SuggestedAnimation => (mountedEntity as EntityBehaviorEquusRideable).curAnim;
